@ONT-7929
Feature: Validating calculate and order creation functi

  Scenario Outline: Validating calculate functionality
    Given user navigates the weborders application
  ...
  Scenario Outline: Validating create order functionality
    ...
    And user creates order with data
      ...
      | MyMoney | 1        | John Doe | 123 My Road | Chicago | IL    | 12345 | 1234123412341234 | 12/22       |
    ...
    Examples:
      ...
      | MyMoney | 5        | Patel Harsh | 124 My Road | Chicago | IL    | 12345 | 1234123412341234 | 07/22       |
      | MyMoney | 1        | Kim Yan     | 125 My Road | Chicago | IL    | 12345 | 1234123412341234 | 03/22       |
